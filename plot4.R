...
# Plot Global Active Power vs Time in upper left corner.
# Plot Votage vs Time in upper right corner
# Plot Sub_metering_1, Sub_metering_2, Sub_metering_3 vs Time in lower left corner
# Plot Global Reactive Power vs Time in lower right corner
...
# Plot Sub_metering_1, Sub_metering_2, Sub_metering_3 vs Time in lower left corner
with(epc, plot(DateTime,Sub_metering_1, type="l", lty = 1, xlab="", ylab="Energy sub metering")) 
...
# Plot Global Reactive Power vs Time in lower right corner
with(epc, plot(DateTime,Global_reactive_power, type="l", xlab = "datetime", ylab="Global Reactive Power")) 
